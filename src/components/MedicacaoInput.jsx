...
const ANTIBIOTICOS = [
  "Ceftriaxona", "Cefazolina", "Cefepime",
  "Amoxicilina + Clavulanato", "Piperacilina + Tazobactam",
  "Meropenem", "Imipenem", "Ertapenem",
  "Vancomicina", "Teicoplanina", "Oxacilina", "Ampicilina",
  "Ciprofloxacino", "Levofloxacino",
  "Metronidazol", "Clindamicina", "Azitromicina",
  "Gentamicina", "Amicacina",
  "Polimixina B", "Linezolida", "Daptomicina",
  "Sulfametoxazol + Trimetoprima",
];

const MEDICACAO_OPTIONS = [
  "Dormonid", "Fentanil", "Propofol", "Ketamina",
  "Dopamina", "Dobutamina", "Precedex", "Morfina",
  "Cisatracurio", "Antibiótico",
];
